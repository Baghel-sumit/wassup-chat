      ...
      <div class="h-[87%] flex flex-row justify-between bg-gray-700">
        <div class="flex flex-col w-2/5 border-r-2 border-gray-900 max-h-full overflow-x-hidden overflow-y-auto">
          ...
          <div class="flex flex-row py-4 px-2 justify-center items-center border-b-2 border-gray-900">
            ...
            <div class="w-full">
              ...
              <span class="text-gray-400">Pick me at 9:00 Am</span>
            </div>
          </div>
          <div class="flex flex-row py-4 px-2 items-center border-b-2 border-gray-900">
            <div class="w-1/4">
              <img
            ...
            <div class="w-full">
              <div class="text-lg font-semibold text-white">Everest Trip 2021</div>
              <span class="text-gray-400">Hi Sam, Welcome</span>
            </div>
          </div>
          <div class="flex flex-row py-4 px-2 items-center border-b-2 border-gray-900">
            <div class="w-1/4">
            ...
            <div class="w-full">
              <div class="text-lg font-semibold text-white">Javascript Indonesia</div>
              <span class="text-gray-400">Evan : some one can fix this</span>
            </div>
          </div>
        </div>
        ...
        <div class="w-2/5 border-l-2 border-gray-900 px-5">
          <div class="flex flex-col">
            <div class="font-semibold text-xl py-4 text-white">Mern Stack Group</div>
            <img
              src="https://source.unsplash.com/L2cxSuKWbpo/600x600"
              class="object-cover rounded-xl h-64"
              alt=""
            />
            <div class="font-semibold py-4 text-white">Created 22 Sep 2021</div>
